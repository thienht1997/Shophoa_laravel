            ...
            <div class="container">
               <div id="sequence">
                  ...
                  <ul class="sequence-canvas">
                     <li class="animate-in">
                        <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead">Flower shop</span></div>
            ...
            <div class="promotion-banner">
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="promo-box"><img src="images/promotion-03.png"  style="height: 112.5px" alt=""></div>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="{{route('shop.details',  $product->id)}}"><img width="183" height="80" src="{{ asset('layouts/img/'.$product->image) }}" alt="Product Name"></a></div>
                       ...
                       <div class="row">
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">{{$product->name}}</div>
                                 <h4 class="price">{{$product->price}}</h4>
                                 <div class="button_group"> <a href="{{route('shop.cart', $product->id)}}"><button class="button add-cart" type="button">Add To Cart</button></a><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           @endforeach
                     </li>
